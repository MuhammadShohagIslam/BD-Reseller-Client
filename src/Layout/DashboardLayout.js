        ...
        <>
            <div className="flex w-screen h-screen max-h-screen overflow-hidden">
                <aside className={`w-72 ${toggleAdminSidebar ? "w-16": ""}`}>
                    <div className="overflow-y-auto h-screen min-h-screen py-4 px-3 bg-gray-50 dark:bg-gray-800">
                        <div className="flex justify-between">
                            <h2 className="text-white font-bold text-start text-2xl pb-4">
                                BD-Seller
                            </h2>
                            <label
                                onClick={()=> setToggleAdminSidebar(!toggleAdminSidebar)}
                                className="btn btn-sm btn-circle border-2 hover:bg-success hover:text-white hover:border-success"
                            >
                                ✕
                            </label>
                        </div>
